...
char *M_StringDuplicate(const char *orig)
{
    ...
    if (result == NULL)
    {
        hal_platform.fatalError("Failed to duplicate string (length %" PRIuPTR ")\n", strlen(orig));
    }
                      ...
                      const char *replacement)
{
    ...
    if (result == NULL)
    {
        hal_platform.fatalError("M_StringReplace: Failed to allocate new string");
        return NULL;
    }
...
char *M_StringJoin(const char *s, ...)
{
    ...
    if (result == NULL)
    {
        hal_platform.fatalError("M_StringJoin: Failed to allocate new string.");
        return NULL;
    }
